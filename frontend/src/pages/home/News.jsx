            ...
            news.map((item, index) => (
                <SwiperSlide key={index}>
                    <div className='flex flex-col items-center gap-12 sm:justify-between sm:flex-row'>
                        ...
                        {/* <div class="flex">
                            <div class="flex-shrink-0 w-40 bg-blue-200">Fixed Width</div>
                            <div class="flex-1 bg-gray-100">Flexible Content</div>
                            </div>
                            
                            flex-shrink-0 keeps the first box at w-40 even if space is tight.
                            The second box grows or shrinks as needed. */}
