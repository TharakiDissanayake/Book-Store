                                ...
                                <div className="lg:col-span-2">
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        <div className="md:col-span-5">
                                            ...
                                            {/*Track the input with the name "name".
                                                Show an error if it's left empty (since it's required). */}
                                            {/* The register() function in React Hook Form connects an input field to the form state and enables validation. */}
                                            <input
