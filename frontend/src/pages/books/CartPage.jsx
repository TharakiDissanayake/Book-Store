...
const CartPage = () => {
    ...
    {/*cartItems.reduce(...): Adds up the newPrice of each item in the cartItems array.
    acc + item.newPrice: acc is the accumulator (starting at 0). Each item.newPrice is added to it.
    .toFixed(2): Rounds the total to 2 decimal places and returns it as a string. */}
