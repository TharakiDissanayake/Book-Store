        ...
        <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
            ...
            <div className='w-full max-w-sm px-8 pt-6 pb-8 mx-auto mb-4 bg-white rounded shadow-md'>
                ...
                The element takes up the full width available. */}
                    ...
                    <div>
                        <button className='px-8 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 focus:out-of-range:'>Login</button>
                    </div>
                </form>
                <p className='mt-4 text-sm font-medium align-baseline'>Haven't an account? Please <Link to='/register' className='text-blue-500 hover:text-blue-700'>Register</Link></p>
